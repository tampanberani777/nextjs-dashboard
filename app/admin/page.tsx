    ...
    <div className="flex min-h-screen bg-gray-100 text-gray-900">
      ...
      <aside className="w-64 bg-gray-800 min-h-screen p-6 text-gray-100">
        ...
        <nav className="flex flex-col space-y-4">
          <span className="text-left px-4 py-2 rounded bg-gray-600 font-semibold">
            Katalog Produk
          </span>
          <span className="text-left px-4 py-2 rounded hover:bg-gray-700">
            Riwayat Transaksi
          </span>
          <span className="text-left px-4 py-2 rounded hover:bg-gray-700">
            Invoices
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded shadow text-center">
              ...
              <p className="text-2xl font-bold">{bestSeller}</p>
            </div>
          </div>
